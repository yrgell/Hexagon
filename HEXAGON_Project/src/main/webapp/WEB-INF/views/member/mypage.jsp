    ...
    <div class="mypage_wrap">
        <div class="myinfo_card_wrap">
            <div class="myinfo_profile_wrap">
                <figure><img alt="" src="/hexagon/resources/images/user.png" id = "mypageProfileImg" style="height: 100px; width: 100px;"></figure>
            ...
            <div class="myinfo_menu_wrap">
                <ul>
                    <li class="basicMenu"><a class="myinfo_menu01" href="${path}myPwdCheck.me">내 기본 정보</a></li>
                    <li><a class="myinfo_menu03" href="${path}mygathering.me">계모임 관리</a></li>
                    <li><a class="myinfo_menu03" href="${path}myFund.me">펀드 관리</a></li>
                    <li><a class="myinfo_menu03" href="${path}myStock.me">주식 관리</a></li>
                    <li><a class="myinfo_menu04" href="${path}mySchedule.me">입금/지급 스케줄</a></li>
                    <li><a class="myinfo_menu06" href="${path}myQnA.me">1:1 문의</a></li>
                </ul>
            </div>
        </div>
