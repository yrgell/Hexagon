        ...
        <div class="myinfo_card_wrap">
            ...
            <div class="myinfo_menu_wrap">
                <ul>
                    ...
                    <li><a class="myinfo_menu03" href="#">계모임 관리</a></li>
                    <li><a class="myinfo_menu03" href="#">투자 관리</a></li>
                    ...
                    <li><a class="myinfo_menu07" href="#">마이샵 관리</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="mypage_menu_each">
            ...
            <ul class="my_adv_list">
                <li><a href = "#">
                    ...
                    <p class="stat" id = "totalCoupon">0장</p></a>
                </li>
                <li><a href = "#">
                    <p class="icon icon02">I-POINT</p>
                    <p class="stat" id = "ipoint">1000</p></a>
                </li>
                <li><a href = "#">
                    <p class="icon icon03">I-PAY</p>
                    <p class="stat" id = "ipay">2000</p></a>
                </li>
                <li><a href = "#">
                    <p class="icon icon04">스탬프</p>
                    <p class="stat" id = "stamp">스탬프</p></a>
                </li>
            </ul>
        </div>
    </div>
       ...
       <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <ul class="adress">
                         <span>Adress</span>    
                         <li>
                            <p>서울특별시 강남구 테헤란로29길 6(역삼동) 25층 </p>
                          </li>
