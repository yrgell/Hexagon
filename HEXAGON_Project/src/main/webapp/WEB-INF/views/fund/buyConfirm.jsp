...
<%@ include file = "../include/header.jsp" %>
  ...
  <form id="confirmForm" action="${path}buyFundPro.me" >
	...
	<input type = "hidden" name = "fund_invest_money" value = "${fund_invest_money }">
	...
	<input type = "hidden" name = "fund_name" value = "${fund_name }">
	  ...
	  <table id="confirm_tbl" border="1">
	  	...
	  	<tr>
	  		<td colspan="4"><input type="text" id="sign" name = "fund_buy_state" placeholder="동의함" required></td>	  		
	  	</tr>
	  	<tr>
	  	...
	  	<tr>
	  		<td>
	  		 <div align = "center">
			  	<input type = "submit" value = "확인 및 투자진행">
			  </div>
	  	</tr>
	  </table>
  </form>
