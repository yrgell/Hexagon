			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form">
					...
					<div class="container-login100-form-btn">
						<input type="button" class="login100-form-btn" onclick="window.location='/hexagon/login.gu'" value="이전">	
                        <input type="button" class="login100-form-btn" onclick="window.location='/hexagon/joinNext.gu'" value="회원가입">
					</div>
				</form>
			</div>
		</div>
