   ...
   <div id="content_joinNext">
	<div class="common_inner sub" id = "detailInfo">
		...
		<div class="container_join">
			<input type="button" class="login100-form-btn" onclick="window.location='/hexagon/join.gu'" value="이전">
			<input type="button" class="login100-form-btn" onclick="window.location='/hexagon/joinPro.gu'" value="다음">
		</div>
	</div>
</div>
<!--contents-->
