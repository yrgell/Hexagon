		...
		<table style="width:1000px; margin:auto;" align="center" border="1" >
			...
			<c:forEach var="dto" items="${dtos}" >
				<tr>
					...
					<td><a href="gath_detail.gu?GATH_NUM=${dto.GATH_NUM}&gath_ref_date=${dto.gath_ref_date}">참여하기</a></td>
				</tr>
			</c:forEach>
			<tr>
			
				<th colspan="9" style=" text-align:center;">
					<a  href="gath_add.me">계생성</a>
				</th>
				<th colspan="2" style=" text-align:center;">
					<a  href="gath_melist.me">나의 계 목록</a>
				</th>
